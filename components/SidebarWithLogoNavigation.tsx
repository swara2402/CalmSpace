...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, user, onSignOut, onLogoClick }) => {
  return (
      ...
      <div className="flex items-center justify-center h-16 w-full mb-8">
        ...
        >
          <div className="relative">
            <div className="w-12 h-12 bg-gradient-to-br from-purple-500 via-blue-500 to-green-400 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30 transform rotate-3 group-hover:rotate-0 transition-transform duration-300">
          ...
          <h1 className="hidden md:inline ml-4 text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent group-hover:from-purple-700 group-hover:to-blue-700 transition-all duration-300">CalmSpace</h1>
        </button>
      </div>
