...
import Sidebar from './components/SidebarWithLogoNavigation';
import ChatWindow from './components/ChatWindow';
import JournalPage from './components/JournalPage';
import ResourcesPage from './components/ResourcesPage';
import CommunityPage from './components/CommunityPage';
import ProfessionalsPage from './components/ProfessionalsPageWithBackground';
...
const App: React.FC = () => {
  ...
  const handleLogoClick = () => {
    // Clear the visited flag and reload to show landing page
    localStorage.removeItem('hasVisitedCalmSpace');
  ...
  const getBackgroundImage = () => {
    switch (activePage) {
      ...
      case 'Journal':
        return 'journal.webp';
      case 'Resources':
        return 'resources.jpg';
      case 'Community':
        return 'community.jpg';
      case 'Professionals':
        return 'professional.jpg';
      default:
        return 'calm-water-surface-at-sunset-free-photo.webp';
    }
  };
  ...
  return (
    <div
      className="h-screen w-screen flex overflow-hidden relative transition-all duration-500"
      style={{
